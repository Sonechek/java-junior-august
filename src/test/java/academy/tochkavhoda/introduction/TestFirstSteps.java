...
public class TestFirstSteps {
    ...
    public void testGetCharByCode() {
        FirstSteps firstSteps = new FirstSteps();
        assertEquals('A', firstSteps.getCharByCode((short)65));
        assertEquals('А', firstSteps.getCharByCode((short)1040));
        assertEquals('1', firstSteps.getCharByCode((short)49));
        assertEquals('\t', firstSteps.getCharByCode((short)9));
        assertEquals('\\', firstSteps.getCharByCode((short)92));
        assertEquals('®', firstSteps.getCharByCode((short)0x00AE));
    }

    @Test
    public void testCodeByChar() {
        FirstSteps firstSteps = new FirstSteps();
        assertEquals(65, firstSteps.getCodeByChar('A'));
        assertEquals(1040, firstSteps.getCodeByChar('А'));
        assertEquals(49, firstSteps.getCodeByChar('1'));
        assertEquals(9, firstSteps.getCodeByChar('\t'));
        assertEquals(92, firstSteps.getCodeByChar('\\'));
        assertEquals(0x00AE, firstSteps.getCodeByChar('®'));
    }

    @Test
    public void testGetCharByOffset() {
        FirstSteps firstSteps = new FirstSteps();
        assertEquals('d', firstSteps.getCharByCodeAndOffset('a', (short) 3));
        assertEquals('я', firstSteps.getCharByCodeAndOffset('ы', (short) 4));
        assertEquals('9', firstSteps.getCharByCodeAndOffset('0', (short) 9));
    }

    @Test
    public void testIsEqualOrGreater() {
        FirstSteps firstSteps = new FirstSteps();
        assertTrue(firstSteps.isGreaterOrEqual('d', 'd'));
        assertTrue(firstSteps.isGreaterOrEqual('x', 'a'));
        assertTrue(firstSteps.isGreaterOrEqual('а', 'b'));
    }

    @Test
    public void testGetAverageChar() {
        FirstSteps firstSteps = new FirstSteps();
        assertEquals('b', firstSteps.getAverageChar('a', 'c'));
        assertEquals('m', firstSteps.getAverageChar('a', 'z'));
        assertEquals('п', firstSteps.getAverageChar('а', 'я'));
    }
}
